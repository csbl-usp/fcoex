...
# fcoex: Introduction and basic pipeline
...
exprs <- as.data.frame(aSingleCellExperiment::ssay(mini_pbmc3k, 'logcounts'))
...
# Taking a look at two ora representations: 
show_ora(fc)[["CD79A"]]$pl
show_ora(fc)[["HLA-DRB1"]]$pl
```
